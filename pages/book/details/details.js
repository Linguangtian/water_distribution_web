var utils = require("../../../utils/helper.js"), WxParse = require("../../../wxParse/wxParse.js"), gSpecificationsModel = require("../../../components/goods/specifications_model.js"), goodsBanner = require("../../../components/goods/goods_banner.js"), goodsInfo = require("../../../components/goods/goods_info.js"), goodsBuy = require("../../../components/goods/goods_buy.js"), quickNavigation = require("../../../components/quick-navigation/quick-navigation.js"), p = 1, is_loading_comment = !1, is_more_comment = !0;
        ...
        getApp().core.showLoading({
            ...
            success: function(t) {
                if (0 == t.code) {
                    ...
                    var a = t.data.info;
                    a.num = t.data.info.stock, a.min_price = .01 < t.data.info.price ? t.data.info.price : "免费", 
                    a.sales_volume = t.data.info.sales, a.service_list = t.data.info.service, i.setData({
                        goods: t.data.info,
