var WxParse = require("./../../wxParse/wxParse.js"), quickNavigation = require("./../../components/quick-navigation/quick-navigation.js");

Page({
    data: {},
    onLoad: function(e) {
        getApp().page.onLoad(this, e), quickNavigation.init(this);
        var t = this;
