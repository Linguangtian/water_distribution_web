var lotteryInter, options_id, timer, luckyTimer, utils = getApp().helper, videoContext = "", WxParse = require("../../wxParse/wxParse.js"), quickNavigation = require("../../components/quick-navigation/quick-navigation.js");
...
Page({
    ...
    onLoad: function(t) {
        if (getApp().page.onLoad(this, t), t.user_id && this.buyZero(), quickNavigation.init(this), 
        "undefined" == typeof my) {
